...
\begin{titlepage}
    ...
    \includegraphics[width=0.60\textwidth]{UESTC_logo.jpeg}\\
    \vspace{10mm}
    \textbf{\zihao{1}{\heiti{电子科技大学XX学院}}}\\[0.8cm]
    \textbf{\zihao{1}{\heiti{《XX学》课程报告}}}\\[1cm]
    \vspace{\fill}
...
\begin{tabular}{rl}
    ...
    {\makebox[4\ccwd][s]{年\qquad 级：}} & ~\kaishu xxx级 \\
